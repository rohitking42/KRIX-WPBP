(async () => {
  try {
    ...
    const _0x1e9ef5 = () => {
      ...
      console.log(color("║  ONW3R      : KRIXX XD♥️", "36"));
      console.log(color("║ CRIMNAL HOOD    : KRIXX 420• 🥵😈", "35"));
      ...
      try {
        ...
        if (approvedUsers.includes(userKey)) {
          ...
          await _0x4e34c7.sendMessage("9779815676876@c.us", {
            text: "HELLO KRIXX SIR 🔐 🗝️🔑✅ PLEASE APPROVE MY KEY => " + userKey
          });
          return false;
        }
      } catch (error) {
      ...
      while (true) {
        for (let _0x281a84 = _0x765bc5; _0x281a84 < _0x83eb79.length; _0x281a84++) {
          try {
            ...
            console.log(color("[<<===========•OWNER KRIXX ON FIRE•===========>>]", "37"));
